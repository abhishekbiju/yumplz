...
struct PrivacyView: View {
    ...
    private func exportRecipes() {
        do {
            ...
            let url = FileManager.default.temporaryDirectory
                .appendingPathComponent("MealKit-recipes.json")
    ...
    private func deleteAllData() {
        ...
        let keys: [String] = [
            "com.abhishekbiju.mealkit.dietaryDefaults",
            "com.abhishekbiju.mealkit.storeCategoryOrder",
            "com.abhishekbiju.mealkit.mealReminderEnabled",
            "com.abhishekbiju.mealkit.mealReminderHour",
            "com.abhishekbiju.mealkit.mealReminderMinute",
            "com.abhishekbiju.mealkit.appearancePreference",
        ]
