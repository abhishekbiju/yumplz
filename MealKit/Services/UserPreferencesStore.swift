...
final class UserPreferencesStore {
    ...
    private enum Key {
        static let dietaryDefaults      = "com.abhishekbiju.mealkit.dietaryDefaults"
        static let storeCategoryOrder   = "com.abhishekbiju.mealkit.storeCategoryOrder"
        static let mealReminderEnabled  = "com.abhishekbiju.mealkit.mealReminderEnabled"
        static let mealReminderHour     = "com.abhishekbiju.mealkit.mealReminderHour"
        static let mealReminderMinute   = "com.abhishekbiju.mealkit.mealReminderMinute"
        static let appearancePreference = "com.abhishekbiju.mealkit.appearancePreference"
    }
