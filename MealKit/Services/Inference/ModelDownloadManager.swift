...
private let log = Logger(subsystem: "com.abhishekbiju.mealkit", category: "ModelDownload")
...
final class ModelDownloadManager: NSObject {
    ...
    nonisolated(unsafe) static let modelsDirectory: URL = {
        ...
        let dir = appSupport.appending(path: "MealKitModels", directoryHint: .isDirectory)
