...
///
/// App Group (`group.com.abhishekbiju.yumplz`) requires a paid Apple
...
enum PendingImportStore {
    ...
    static let appGroupID = "group.com.abhishekbiju.yumplz"
    ...
    static var containerDirectory: URL {
        ...
        let fallback = FileManager.default.temporaryDirectory
            .appendingPathComponent("yumplzPendingImports", isDirectory: true)
