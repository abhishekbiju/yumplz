...
/// Runs the real on-device model when available. Enable with MEALKIT_LIVE_LLM=1.
final class RecipePromptLiveTests: XCTestCase {
    ...
    override func setUp() async throws {
        ...
        guard ProcessInfo.processInfo.environment["MEALKIT_LIVE_LLM"] == "1" else {
            throw XCTSkip("Set MEALKIT_LIVE_LLM=1 to run live Llama prompt tests")
        }
    }
